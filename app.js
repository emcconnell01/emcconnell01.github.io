...
function loadMoviesFromServer() {
	fetch("https://s23-deploy-emcconnell01-production.up.railway.app/games", {
		credentials: 'include'
		...
		array.forEach(function (movie) {
			...
			editButton.onclick = function () {
				...
				function updateMovieOnServer(movieName, movieRating, movieGenre, movieYear, moviePlatform, movieId) {
					...
					fetch("https://s23-deploy-emcconnell01-production.up.railway.app/games/" + movieId, {
						credentials: 'include',
						method: "PUT",
						body: data,
						headers: {
...
function createUserOnServer(firstName, lastName, email, password) {
	...
	fetch("https://s23-deploy-emcconnell01-production.up.railway.app/users", {
		credentials: 'include',
		method: "POST",
		body: data,
		headers: {
...
function loginUserOnServer(logEmail, logPassword) {
	...
	fetch("https://s23-deploy-emcconnell01-production.up.railway.app/sessions", {
		credentials: 'include',
		method: "POST",
		body: data,
		headers: {
